...
public class FeeProcessController {
    ...
    @GetMapping("/receipts")
    @Retry(name = "fee-service", fallbackMethod = "fallbackGetAllReceipts")
    ...
    @Retry(name = "fee-service", fallbackMethod = "fallbackGetReceipt")
    ...
    public ResponseEntity<Payment> fallbackGetReceipt(long id , Throwable ex) {
